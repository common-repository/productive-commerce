...
?>
    <p>
        <h2><?php echo esc_html__( 'Breakpoints and Gap Settings for Grids', 'productive-commerce' ) ?></h2>
        <div><?php echo esc_html__( 'These setting are relevant to all grids that are generated by our plugins and themes.', 'productive-commerce' ) ?></div>
    </p>
<?php
}
...
function productive_global_add_section_grid_fields($productive_global_section_grid_options) {
    ...
    add_settings_field(
        ...
        __( 'Row Gap (px)', 'productive-commerce' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Column Gap (px)', 'productive-commerce' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Widescreen Breakpoint', 'productive-commerce' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Columns per row', 'productive-commerce' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Desktop Breakpoint', 'productive-commerce' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Tablet (Lanscape) Breakpoint', 'productive-commerce' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Tablet (Portrait) Breakpoint', 'productive-commerce' ), // Field label
...
function productive_global_callback_grid_heading_gaps( $args ) {
    ?>
    <h3><?php echo esc_html__( 'Grid Gaps', 'productive-commerce' ) ?></h3>
   <?php
}
...
function productive_global_callback_grid_heading_widescreen( $args ) {
    ?>
    <h3><?php echo esc_html__( 'Widescreens', 'productive-commerce' ) ?></h3>
   <?php
}
...
function productive_global_callback_grid_cols_per_row_widescreen( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Columns per row in a grid on Widescreens', 'productive-commerce' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_grid_heading_desktop( $args ) {
    ?>
    <h3><?php echo esc_html__( 'Desktop', 'productive-commerce' ) ?></h3>
   <?php
}
...
function productive_global_callback_grid_heading_tablet_landscape( $args ) {
    ?>
    <h3><?php echo esc_html__( 'Tablet (Landscape)', 'productive-commerce' ) ?></h3>
   <?php
}
...
function productive_global_callback_grid_cols_per_row_tablet_landscape( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Columns per row in a grid on Tablet (Landscape)', 'productive-commerce' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_grid_heading_tablet_portrait( $args ) {
    ?>
    <h3><?php echo esc_html__( 'Tablet (Portrait)', 'productive-commerce' ) ?></h3>
   <?php
}
...
function productive_global_callback_grid_cols_per_row_tablet_portrait( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Columns per row in a grid on Tablet (Portrait)', 'productive-commerce' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_grid_heading_mobile_landscape( $args ) {
    ?>
    <h3><?php echo esc_html__( 'Mobile (Landscape)', 'productive-commerce' ) ?></h3>
   <?php
}
...
function productive_global_callback_grid_cols_per_row_mobile_landscape( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Columns per row in a grid on Mobile (Landscape)', 'productive-commerce' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_grid_heading_mobile_portrait( $args ) {
    ?>
    <h3><?php echo esc_html__( 'Mobile (Portrait)', 'productive-commerce' ) ?></h3>
   <?php
}
...
function productive_global_callback_grid_cols_per_row_mobile_portrait( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Columns per row in a grid on Mobile (Portrait)', 'productive-commerce' ); ?>
        </p>
    <?php
}
