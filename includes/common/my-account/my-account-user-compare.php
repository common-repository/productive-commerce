...
/**
 * Method productive_commerce_delete_compare_product_popup.
 */
function productive_commerce_delete_compare_product_popup() {
    ...
    <div class="productive_popup std_popup <?php echo esc_attr($is_on_productive_global_popup_use_theme_style); ?> <?php echo esc_attr($is_on_productive_global_popup_close_with_esc_key_enable); ?> <?php echo esc_attr($is_on_productive_global_popup_close_with_click_elsewhere_enable); ?>" id="productive_popup_delete_compare_product_popup" data-enter-exit-transition-commerce="<?php echo esc_attr($productive_global_popup_transition_direction); ?>">
      <div class="productive_popup-overlay delete_compare_product">
        <header class="productive_popup-header" id="productive_popup-header-delete_compare_product">
            <?php echo __( 'Remove from Comparison', 'productive-commerce' ); ?>
        </header>
                        ...
                        <div class="form-or-container">
                            <div>
                                <div class="productiveminds_section_cancel_or_go_confirm_container ">
                                    <a href="#" class="cancel-confirmed productiveminds_section_container_compare_remove_no" data-product_id="" data-quantity="1" rel="nofollow">
                                        <?php echo __( 'Cancel', 'productive-commerce' ); ?>
                                    </a>
                                    |
                                    <a href="#" class="remove-confirmed productiveminds_section_container_compare_remove_yes" data-product_id="" data-quantity="1" rel="nofollow">
...
add_action('wp_footer', 'productive_commerce_delete_compare_product_popup');
